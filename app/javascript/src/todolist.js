...
class ToDoList extends React.Component {
  ...
  fetchTasks() {
    fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=28")
      .then(checkStatus)
      .then(json)
      .then((response) => {
  ...
  deleteTask(id) {
    ...
    fetch(`https://fewd-todolist-api.onrender.com/tasks/${id}?api_key=28`, {
      method: "DELETE",
      mode: "cors",
    }).then(checkStatus)
      .then(json)
  ...
  toggleComplete(id, completed) {
    ...
    fetch(`https://fewd-todolist-api.onrender.com/tasks/${id}/mark_${newState}?api_key=28`, {
      method: "PUT",
      mode: "cors",
    }).then(checkStatus)
      .then(json)
      ...
      <div className="container">
        <div className="row">
          <div className="col-12">
            <h2 className="mb-3 mt-5">To Do List</h2>
